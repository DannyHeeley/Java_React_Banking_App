...
public class Transactions {
    ...
    public void addTransaction(TransactionType transactionType, float amount, AccountBase account) {
        TransactionDAO transactionDAO = new TransactionDAO();
        TransactionEntry entry = new TransactionEntry(transactionType, amount, account.getAccountId());
        entry.setTransactionId(transactionDAO.saveNew(account, transactionType, amount));
