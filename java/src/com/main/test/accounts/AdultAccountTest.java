...
class AdultAccountTest {
    ...
    void depositWithMinusValueThrowsException() {
        AdultAccount adultAccount1 = new AdultAccount(userName, 0f, firstName, lastName, dateOfBirth, email);
        assertThrows(RuntimeException.class, () -> adultAccount1.deposit(-100f));

        AdultAccount adultAccount2 = new AdultAccount("Another Adult", 100f, firstName, lastName, dateOfBirth, email);
